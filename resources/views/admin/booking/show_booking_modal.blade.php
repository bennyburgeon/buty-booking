    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12 text-right mt-2 mb-2">
               ...
               @if ($user->roles()->withoutGlobalScopes()->first()->hasPermission('create_booking') && $booking->date_time!='' && $booking->date_time->greaterThanOrEqualTo(\Carbon\Carbon::now()) && $current_emp_role->name != 'customer')
               ...
               @endif
               @if ($user->roles()->withoutGlobalScopes()->first()->hasPermission('update_booking') && $current_emp_role->name != 'customer')
                ...
                <div class="row">
                   <div class="col-md-12">
                      <table class="table table-condensed">
                         ...
                         @endif
                         @if ($user->can('update_booking') && $current_emp_role->name == 'administrator' && $booking->payment_status == 'pending')
                            <tr>
                      ...
                      <table class="table table-condensed">
                         ...
                         <tr class="h6">
                            ...
                            <td>
                               ...
                               <span class="text-success  font-weight-normal"><i class="fa fa-check-circle"></i> {{ __('app.'.$booking->payment_status) }}</span>
                            </td>
                            @endif
