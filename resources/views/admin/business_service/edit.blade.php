                    ...
                    <form role="form" id="createForm"  class="ajax-form" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-success category-modal" id="add-category" type="button"><i class="fa fa-plus"></i> @lang('app.add')</button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>@lang('modules.services.time')<span class="text-danger">*</span></label>
                                    <div class="input-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="tax_ids[]" id="tax_ids" class="form-control form-control-lg select2" multiple="multiple">
                                        <option value="0" class="disable">@lang('app.select') @lang('app.tax')</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('app.assign') @lang('app.employee')<span class="text-danger">*</span></label>
                                    <select name="employee_ids[]" id="employee_ids" class="form-control form-control-lg select2" multiple="multiple" style="width: 100%">
                                        <option value="0" class="disable">@lang('app.select') @lang('app.employee')</option>
