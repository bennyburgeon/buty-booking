...
<div class="container">
    <div class="row" style="margin-top: 30px">
        <div class="text-center m-t-20 mt-20 bg-primary" style="padding: 20px">
            <img class="text-center" src="{{ asset('assets/img/logo.png') }}" style="max-width: 240px" alt="Home"/>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Server Requirements.
                    ...
                    @else
                        <span class="pull-right">Current PHP Version: {{ phpversion() }} <i data-bs-toggle="tooltip"
